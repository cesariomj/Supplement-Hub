// planner.js - Fixed & Clean Weekly Planner

console.log('📅 planner.js loaded');

// Make constants global so other files can access them safely
...
// ... (keep the rest of your functions: quickFillBottle, updatePlannerServings, etc.)
